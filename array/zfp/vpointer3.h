// pointer to a 3D array element; this class is nested within zfp::varray3
class pointer {
public:
  pointer() : ref(0, 0, 0, 0) {}
...
protected:
  ...
  explicit pointer(varray3* array, uint i, uint j, uint k) : ref(array, i, j, k) {}
...
public:
  varray3 const & data() const { return *(ref.array); }
};
